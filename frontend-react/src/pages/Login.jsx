...
const Login = () => {
  ...
  async function handleLogin(e){
    ...
    const response  = await axios.post('https://ieee-hackathon-2024-codecrafters-1.onrender.com/api/user/login', {
      email,
      password
        }, 
        {
  ...
  return (
    <div className='k_k_login-page'>
      <div id='k_k_img-nature'>
        ...
        <img src="../../images/colorful.png" alt="" id='k_k_nature-img' />
      </div>
      <div id='k_k_login'>
        {/* <img src="../../images/login-logo1.png" alt="" id='k_k_logo'/> */}
        <img src="../../images/PicfinityLogowhite.png" alt="" id='k_k_logo'/>
        <div className='k_k_cred'>
            ...
            {/* <div id='k_k_forget'>Forgot Password?</div> */}
